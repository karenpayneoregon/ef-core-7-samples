...
/// <summary>
/// https://github.com/dotnet/EntityFramework.Docs/blob/main/samples/core/Miscellaneous/NewInEFCore7/QueryStatisticsLoggerSample.cs
/// </summary>
public static class QueryStatisticsLoggerSample
{

    public static async Task ExecutingCommandsAfterConsumingAResultSet()
    {
        ...
        var serviceProvider = new ServiceCollection()
            .AddDbContext<CustomerContext>(b => b.UseLoggerFactory(loggerFactory)
                    .UseSqlServer(@"Server=(localdb)\mssqllocaldb;Database=EF.ConsumedDataReaderSample"))
